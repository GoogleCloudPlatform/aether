...
use crate::mir::{BasicBlock, Function, Program};
...
impl DwarfGenerator {
    ...
    fn create_parameter_die(
        &self,
        index: usize,
        param: &crate::mir::Local,
    ) -> Result<DebugInfoEntry, SemanticError> {
        Ok(DebugInfoEntry {
    ...
    fn generate_function_line_info(
        &mut self,
        _name: &str,
        function: &Function,
    ) -> Result<(), SemanticError> {
