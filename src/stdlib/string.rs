...
pub fn create_string_module() -> Module {
    ...
    external_functions.insert(
        ...
        create_external_function_named(
            ...
            vec![("str1", string_type.clone()), ("str2", string_type.clone())],
            string_type.clone(),
            CallingConvention::C,
        ),
    );
    ...
    external_functions.insert(
        ...
        create_external_function_named(
            ...
            vec![("str", string_type.clone()), ("index", size_type.clone())],
            char_type.clone(),
            CallingConvention::C,
        ),
    );
    ...
    functions.insert(
        ...
        create_function_stub(
            "repeat",
            vec![("str", string_type.clone()), ("count", int_type.clone())],
            string_type.clone(),
        ),
    );
    ...
    Module {
        ...
        intent: Some(
            "Provides comprehensive string manipulation and utility functions".to_string(),
        ),
        imports: vec![],
        exports: vec![
...
mod tests {
    ...
    fn test_string_module_creation() {
        ...
        assert!(module
            .external_functions
            .iter()
            .any(|f| f.name.name == "string_length"));
        assert!(module
            .external_functions
            .iter()
            .any(|f| f.name.name == "string_concat"));
        assert!(module
            .external_functions
            .iter()
            .any(|f| f.name.name == "string_compare"));
        assert!(module
            .external_functions
            .iter()
            .any(|f| f.name.name == "string_substring"));

        // Check utility functions
        assert!(module
            .function_definitions
            .iter()
            .any(|f| f.name.name == "starts_with"));
        assert!(module
            .function_definitions
            .iter()
            .any(|f| f.name.name == "ends_with"));
        assert!(module
            .function_definitions
            .iter()
            .any(|f| f.name.name == "contains"));
        assert!(module
            .function_definitions
            .iter()
            .any(|f| f.name.name == "is_numeric"));

        // Check exports
        assert!(module.exports.iter().any(
            |e| matches!(e, ExportStatement::Function { name, .. } if name.name == "string_length")
        ));
